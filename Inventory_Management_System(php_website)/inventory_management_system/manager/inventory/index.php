  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        <tr<?php if ($row['quantity'] < 10) echo ' class="table-danger fw-bold"'; ?>>
          <td><?php echo $i++; ?></td>
          ...
          <td><a href="edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Edit</a></td>
        </tr>
        <?php endwhile; else: ?>
        <tr><td colspan="8" class="text-center">No inventory items found.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
