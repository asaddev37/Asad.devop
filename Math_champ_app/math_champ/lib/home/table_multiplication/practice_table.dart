...
import 'package:math_champ/home/table_multiplication/practice_table/choose_practice_table.dart';
...
class PracticeTable extends StatefulWidget {
  const PracticeTable({super.key});

  @override
  _PracticeTableState createState() => _PracticeTableState();
}

class _PracticeTableState extends State<PracticeTable> {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in PracticeTable');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in PracticeTable: $e');
    }
  }
      ...
      ..initialize().then((_) {
        if (mounted) {
          setState(() {
            ...
            debugPrint('🎥 VideoPlayer initialized in PracticeTable');
          });
        }
      }).catchError((e) {
        debugPrint('❌ VideoPlayer initialization error in PracticeTable: $e');
      });
  }
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and VideoPlayer in PracticeTable');
    super.dispose();
  }
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text(
                            "Get Ready to Practice Multiplication! 🎉",
                            style: TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                          ...
                          const SizedBox(height: 16),
                          Text(
                            "Watch the video above to refresh your multiplication skills! Then, tap the button below to choose your multiplication tables and start solving fun problems. Let’s become multiplication superstars! 🌟",
                            style: TextStyle(
                              fontSize: 18,
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          ...
                          pageBuilder: (context, animation, secondaryAnimation) => const PracticeSetupPage(),
