...
class PracticeSetupPage extends StatefulWidget {
  ...
  @override
  _PracticeSetupPageState createState() => _PracticeSetupPageState();
}
class _PracticeSetupPageState extends State<PracticeSetupPage> with TickerProviderStateMixin {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in PracticeSetupPage');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in PracticeSetupPage: $e');
    }
  }
  ...
  Future<bool> _onWillPop() async {
    ...
    return await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Exit Practice Setup? 🚪'),
        content: const Text('Are you sure you want to leave without starting your multiplication practice? 🌟'),
        actions: [
          TextButton(
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in PracticeSetupPage');
    super.dispose();
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              "Pick your tables, range, and number of questions for a fun multiplication practice! 🚀",
                              style: TextStyle(
                                fontSize: 16,
