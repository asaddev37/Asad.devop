...
import '/main.dart';
import 'reveal_addition.dart';

enum Difficulty { easy, medium, hard }

class ChooseAddition extends StatefulWidget {
  const ChooseAddition({super.key});

  @override
  _ChooseAdditionState createState() => _ChooseAdditionState();
}

class _ChooseAdditionState extends State<ChooseAddition> with TickerProviderStateMixin {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in ChooseAddition');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in ChooseAddition: $e');
    }
  }
  ...
  void _updateMaxQuestions() {
    int count = 0;
    for (int a = _smallestNumber; a <= _largestNumber; a++) {
      for (int b = _smallestNumber; b <= _largestNumber - a; b++) {
        int sum = a + b;
        if (sum <= _largestNumber) {
  ...
  Future<bool> _onWillPop() async {
    ...
    return await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to leave without starting your addition adventure? 🌟'),
        actions: [
          TextButton(
  ...
  void _validateAndProceed() {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => RevealAddition(
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in ChooseAddition');
    super.dispose();
  }
                            ...
                            child: Container(
                              ...
                              child: Text(
                                _difficulty == Difficulty.easy
                                    ? "Let’s add easy, champ!"
                                    : _difficulty == Difficulty.medium
                                    ? "Ready for more adding?"
                                    : "Big addition, superstar!",
                                style: TextStyle(
                                  fontSize: 14,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 12),
                              Text(
                                "Practice makes perfect! Pick your numbers and how many questions you want to master. Bigger ranges mean bigger challenges! 🚀",
                                style: TextStyle(
                                  fontSize: 16,
