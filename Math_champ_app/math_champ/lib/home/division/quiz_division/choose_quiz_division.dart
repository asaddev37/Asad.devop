...
import '/main.dart';
import 'reveal_quiz_division.dart';

enum Difficulty { easy, medium, hard }

class ChooseQuizDivision extends StatefulWidget {
  const ChooseQuizDivision({super.key});

  @override
  _ChooseQuizDivisionState createState() => _ChooseQuizDivisionState();
}

class _ChooseQuizDivisionState extends State<ChooseQuizDivision> with TickerProviderStateMixin {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in ChooseQuizDivision');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in ChooseQuizDivision: $e');
    }
  }
  ...
  Future<bool> _onWillPop() async {
    ...
    return await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to leave without starting your division quiz? 🌟'),
        actions: [
          TextButton(
  ...
  void _validateAndProceed() {
    ...
    if (_smallestNumber < 1) {
      ...
      showErrorOverlay(
        context: context,
        message: 'The smallest number must be at least 1 and not zero! 🌟',
        onDismiss: () => _playSound('assets/sounds/cliick.wav'),
        tickerProvider: this,
      );
      return;
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => RevealQuizDivision(
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in ChooseQuizDivision');
    super.dispose();
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              "Choose your numbers, questions, and time per question. Get ready for a fun division quiz! 🚀",
                              style: TextStyle(
                                fontSize: 16,
