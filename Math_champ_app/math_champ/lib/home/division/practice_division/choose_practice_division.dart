  ...
  import '/main.dart';
  import 'reveal_practice_division.dart';

  enum Difficulty { easy, medium, hard }

  class ChoosePracticeDivision extends StatefulWidget {
    const ChoosePracticeDivision({super.key});

    @override
    _ChoosePracticeDivisionState createState() => _ChoosePracticeDivisionState();
  }

  class _ChoosePracticeDivisionState extends State<ChoosePracticeDivision> with TickerProviderStateMixin {
    ...
    Future<void> _initializeAudioPlayer() async {
      try {
        ...
        debugPrint('🔊 AudioPlayer initialized in ChoosePracticeDivision');
      } catch (e) {
        debugPrint('❌ AudioPlayer initialization error in ChoosePracticeDivision: $e');
      }
    }
    ...
    Future<bool> _onWillPop() async {
      ...
      return await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('Are you sure you want to leave without starting your division practice? 🌟'),
          actions: [
            TextButton(
    ...
    void _validateAndProceed() {
      ...
      Navigator.push(
        ...
        PageRouteBuilder(
          ...
          pageBuilder: (context, animation, secondaryAnimation) => RevealPracticeDivision(
    ...
    void dispose() {
      ...
      debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in ChoosePracticeDivision');
      super.dispose();
    }
                            ...
                            child: Container(
                              ...
                              child: Text(
                                _difficulty == Difficulty.easy
                                    ? "Let’s practice easy division!"
                                    : _difficulty == Difficulty.medium
                                    ? "Ready for a division challenge?"
                                    : "Tough division, superstar! 🚀",
                                style: TextStyle(
                                  fontSize: 14,
