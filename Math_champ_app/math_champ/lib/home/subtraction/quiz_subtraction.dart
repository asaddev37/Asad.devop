...
import 'package:math_champ/home/subtraction/quiz_subtraction/set_quiz_subtraction.dart';
...
class QuizSubtraction extends StatefulWidget {
  const QuizSubtraction({super.key});

  @override
  _QuizSubtractionState createState() => _QuizSubtractionState();
}

class _QuizSubtractionState extends State<QuizSubtraction> with TickerProviderStateMixin {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in QuizSubtraction');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in QuizSubtraction: $e');
    }
  }
  ...
  Future<void> _initializeVideoPlayer() async {
    _videoController = VideoPlayerController.asset('videos/quiz.mp4')
      ..initialize().then((_) {
        ...
        debugPrint('🎥 VideoPlayer initialized in QuizSubtraction');
      }).catchError((e) {
        debugPrint('❌ VideoPlayer initialization error in QuizSubtraction: $e');
      });
  }
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed VideoPlayer, AudioPlayer, and ConfettiController in QuizSubtraction');
    super.dispose();
  }
  ...
  void _startQuizSetup() {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => const QuizSetupSubtraction(),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                "Watch this fun video to learn about subtraction quizzes! Then, set up your quiz by choosing numbers, difficulty, and time. Ready to be a subtraction superstar? Let’s go! 🎉",
                                style: TextStyle(
                                  fontSize: 18,
