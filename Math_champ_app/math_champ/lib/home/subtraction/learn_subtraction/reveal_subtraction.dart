...
class _RevealSubtractionState extends State<RevealSubtraction> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showErrorOverlay(
        context: context,
        message: "Let’s learn subtraction, champ! 🚀 Flip each card to see the question and answer! 🌟",
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in RevealSubtraction');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in RevealSubtraction: $e');
    }
  }
            ...
            AlertDialog(
              ...
              content: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "You learned ${widget.questionCount} subtraction questions! You're a subtraction superstar! 🌟",
                      style: TextStyle(
                        fontSize: 18,
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in RevealSubtraction');
    super.dispose();
  }
                          ...
                          child: Container(
                            ...
                            child: Text(
                              widget.difficulty == Difficulty.easy
                                  ? "Easy subtracting, champ! 🌟"
                                  : widget.difficulty == Difficulty.medium
                                  ? "Medium subtracting fun! 🚀"
                                  : "Hard subtracting, superstar! 💪",
                              style: TextStyle(
                                fontSize: 14,
