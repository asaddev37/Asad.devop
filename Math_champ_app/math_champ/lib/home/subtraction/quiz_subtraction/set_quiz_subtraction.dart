...
import '/main.dart';
import 'reveal_quiz_subtraction.dart';
import '../../table_multiplication/widgets.dart';

enum Difficulty { easy, medium, hard }
class QuizSetupSubtraction extends StatefulWidget {
  const QuizSetupSubtraction({super.key});

  @override
  _QuizSetupSubtractionState createState() => _QuizSetupSubtractionState();
}
class _QuizSetupSubtractionState extends State<QuizSetupSubtraction> with TickerProviderStateMixin {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in QuizSetupSubtraction');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in QuizSetupSubtraction: $e');
    }
  }
      ...
      for (int subtrahend = _smallestNumber; subtrahend <= minuend; subtrahend++) {
        ...
        if (difference >= _smallestNumber && difference <= _largestNumber) {
          if (_difficulty == Difficulty.easy ||
              (_difficulty == Difficulty.medium && difference >= 10) ||
              (_difficulty == Difficulty.hard && difference >= 20)) {
            count++;
          }
        }
      }
  ...
  Future<bool> _onWillPop() async {
    ...
    return await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to leave without starting your subtraction quiz? 🌟'),
        actions: [
          TextButton(
  ...
  void _validateAndProceed() {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => RevealQuizSubtraction(
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer and ConfettiController in QuizSetupSubtraction');
    super.dispose();
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              "Choose your numbers, questions, and time per question. Get ready for a fun subtraction quiz! 🚀",
                              style: TextStyle(
                                fontSize: 16,
