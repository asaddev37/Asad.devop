...
import 'package:math_champ/home/subtraction/learn_subtraciton.dart';
import 'package:math_champ/home/subtraction/practice_subtraction.dart';
import 'package:math_champ/home/subtraction/quiz_subtraction.dart';
...
class _SubtractionState extends State<Subtraction> {
  ...
  Future<void> _initializeAudioPlayer() async {
    try {
      ...
      debugPrint('🔊 AudioPlayer initialized in Subtraction');
    } catch (e) {
      debugPrint('❌ AudioPlayer initialization error in Subtraction: $e');
    }
  }
  ...
  void dispose() {
    ...
    debugPrint('🗑️ Disposed AudioPlayer in Subtraction');
    super.dispose();
  }
  ...
  Widget _buildSubmoduleCard({
    ...
    final buttonWidth = (MediaQuery.of(context).size.width - 32 - 12) / 2; // Match home.dart, addition.dart
    return SizedBox(
      width: buttonWidth,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "Hey, math superstars! 🌟 Ready to dive into the world of subtraction? Pick an activity below and let’s make taking away numbers a fun adventure! 🚀",
                              style: TextStyle(
                                fontSize: 18,
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                ...
                                pageBuilder: (context, animation, secondaryAnimation) => const LearnSubtraction(),
                        ...
                        _buildSubmoduleCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                transitionDuration: const Duration(milliseconds: 800),
                                pageBuilder: (context, animation, secondaryAnimation) => const PracticeSubtraction(),
                                transitionsBuilder: (context, animation, secondaryAnimation, child) {
                                  const begin = Offset(1.0, 0.0);
                                  const end = Offset.zero;
                                  const curve = Curves.easeInOut;
                        ...
                        _buildSubmoduleCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                transitionDuration: const Duration(milliseconds: 800),
                                pageBuilder: (context, animation, secondaryAnimation) => const QuizSubtraction(),
                                transitionsBuilder: (context, animation, secondaryAnimation, child) {
                                  const begin = Offset(1.0, 0.0);
                                  const end = Offset.zero;
                                  const curve = Curves.easeInOut;
